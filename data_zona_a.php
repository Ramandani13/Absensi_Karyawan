<!-- <button style="position:relative;margin-left:20px;"><a href="a_logistik.php"><h style="color:red;">LOGISTIK</h></a></button>
<button style="position:relative;margin-left:20px;"><a href="a_ckd_non_maxi.php"><h style="color:red;">CKD_NON_MAXI</h></a></button>
<button style="position:relative;margin-left:20px;"><a href="a_ckd.php"><h style="color:red;">CKD</h></a></button>
<button style="position:relative;margin-left:20px;"><a href="a_pod.php"><h style="color:red;">POD</h></a></button>
<button style="position:relative;margin-left:20px;"><a href="a_big_eg_export.php"><h style="color:red;">BIG_EG_EXPORT</h></a></button>
<button style="position:relative;margin-left:20px;"><a href="a_id_adm.php"><h style="color:red;">ID_ADM</h></a></button>
<button style="position:relative;margin-left:20px;"><a href="a_cbu.php"><h style="color:red;">CBU</h></a></button>
<button style="position:relative;margin-left:20px;"><a href="a_ckd_line_g.php"><h style="color:red;">CKD_LINE_G</h></a></button>
<button style="position:relative;margin-left:20px;"><a href="a_ckd_line_l.php"><h style="color:red;">CKD_LINE_L</h></a></button>
<div style="position:relative;left:1500px;top:-30px;"><a href="../index.php"><img style="border-radius:20px;" src="image/orb.gif" width="50px" height="50px;"></a>	</div>
 -->
...
<body class="sidebar-collapse">
    ...
    <div class="page-wrapper">
        ...
        <center><h5 style="font-size:20px;">DATA ABSENSI GROUP A</h5></center>
        <div style="position:relative;left:1500px;top:-30px;"><a href="../absen/index.php"><img style="border-radius:20px;" src="image/orb.gif" width="50px" height="50px;"></a>	</div>
            <div class="col-auto">
                <a href="a_logistik.php"><button class="button button--primary button--load is-active"  type="submit" style="width:200px;height:40px;"><span class="button__icon button__icon--left">
                    <svg class="icon-icon-refresh">
                    <use xlink:href="#icon-refresh"></use>
                    </svg></span><span class="button__text">LOGISTIK</span>
                </button></a>
                <a href="a_ckd_non_maxi.php"><button class="button button--primary button--load is-active"  type="submit" style="width:200px;height:40px;"><span class="button__icon button__icon--left">
                    <svg class="icon-icon-refresh">
                    <use xlink:href="#icon-refresh"></use>
                    </svg></span><span class="button__text">CKD_NON_MAXI</span>
                </button></a>
                <a href="a_ckd.php"><button class="button button--primary button--load is-active"  type="submit" style="width:200px;height:40px;"><span class="button__icon button__icon--left">
                    <svg class="icon-icon-refresh">
                    <use xlink:href="#icon-refresh"></use>
                    </svg></span><span class="button__text">CKD</span>
                </button></a>
                <a href="a_pod.php"><button class="button button--primary button--load is-active"  type="submit" style="width:200px;height:40px;"><span class="button__icon button__icon--left">
                    <svg class="icon-icon-refresh">
                    <use xlink:href="#icon-refresh"></use>
                    </svg></span><span class="button__text">POD</span>
                </button></a>
                <a href="a_big_eg_export.php"><button class="button button--primary button--load is-active"  type="submit" style="width:200px;height:40px;"><span class="button__icon button__icon--left">
                    <svg class="icon-icon-refresh">
                    <use xlink:href="#icon-refresh"></use>
                    </svg></span><span class="button__text">BIG_EG_EXPORT</span>
                </button></a>
                <a href="a_id_adm.php"><button class="button button--primary button--load is-active"  type="submit" style="width:200px;height:40px;"><span class="button__icon button__icon--left">
                    <svg class="icon-icon-refresh">
                    <use xlink:href="#icon-refresh"></use>
                    </svg></span><span class="button__text">ID_ADM</span>
                </button></a>
                <a href="a_cbu.php"><button class="button button--primary button--load is-active"  type="submit" style="width:200px;height:40px;"><span class="button__icon button__icon--left">
                    <svg class="icon-icon-refresh">
                    <use xlink:href="#icon-refresh"></use>
                    </svg></span><span class="button__text">CBU</span>
                </button></a>
                <a href="a_ckd_line_g.php"><button class="button button--primary button--load is-active"  type="submit" style="width:200px;height:40px;"><span class="button__icon button__icon--left">
                    <svg class="icon-icon-refresh">
                    <use xlink:href="#icon-refresh"></use>
                    </svg></span><span class="button__text">CKD_LINE_G</span>
                </button></a>
                <a href="a_ckd_line_l.php"><button class="button button--primary button--load is-active"  type="submit" style="width:200px;height:40px;"><span class="button__icon button__icon--left">
                    <svg class="icon-icon-refresh">
                    <use xlink:href="#icon-refresh"></use>
