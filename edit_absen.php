...
<body>
  ...
  <form  method="post" action="">
      ...
      $id = $_GET['id'];
      $no = 1;
      $sql1 = mysqli_query($koneksi,"SELECT * FROM tb_absen WHERE id ='$id' ");
      $sql_record = mysqli_query($koneksi,"SELECT * FROM tb_absen_record WHERE id ='$id' ");
...
$update = mysqli_query($koneksi,"UPDATE tb_absen_record SET hadir='$hadir',ot='$ot',op_pengganti='$op_pengganti',pembimbing='$pembimbing',pengecek='$pengecek',catatan='$catatan' WHERE id = '$id' ");
if ($update){
